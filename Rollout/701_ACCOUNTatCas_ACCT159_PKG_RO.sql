/*
  ...
  Script:      701_ACCOUNTatCas_ACCT159_PKG_RO
  Schema:      ACCOUNT
  Author:      Cristhian Caro
  Date:        02/15/2021
  Purpose:     Query bank account verification history attempts
...
@PKG_VERIFICATION_ATTEMPT_P.sql;
sho ERRORS

CREATE OR REPLACE EDITIONABLE PUBLIC SYNONYM "PKG_VERIFICATION_ATTEMPT" FOR "ACCOUNT"."PKG_VERIFICATION_ATTEMPT_P";
sho ERRORS
