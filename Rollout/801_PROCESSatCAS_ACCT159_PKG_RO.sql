/*
  ...
  Script:      801_PROCESSatCAS_ACCT159_PKG_RO.sql
  Schema:      PROCESS
  Author:      Cristian Gomez
  Date:        03/12/2021
  Purpose:     Query bank account verification.
...
@PKG_BATCH_BANK_ACC_VERIFY_P.sql;
sho ERRORS

CREATE OR REPLACE EDITIONABLE PUBLIC SYNONYM "PKG_BATCH_BANK_ACC_VERIFY" FOR "PROCESS"."PKG_BATCH_BANK_ACC_VERIFY_P";
sho ERRORS
