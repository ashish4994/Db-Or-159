/*
  ...
  Script:      601_ACHatCas_ACCT159_PKG_RB.sql
  Schema:      ACH
  Author:      Cristhian Caro
  Date:        02/03/2021
  Purpose:     Rolback changes in PKG_EWS_VERIFICATION
...
@PKG_ACH_TRANSACTION_R
sho ERRORS

CREATE OR REPLACE EDITIONABLE PUBLIC SYNONYM PKG_ACH_TRANSACTION FOR ACH.PKG_ACH_TRANSACTION_R;
sho ERRORS
