/*
  ...
  Script:      101_IFLOWatCas_ACCT159_DML_RB_VAL.sql
  Schema:      IFLOW
  Author:      Jyoti Jerath
  Date:        11/19/2020
  Purpose:     validate Del_T_APPLICATION_CONFIGURATIONS for EWS SOAP Service configuration and its switch value, and DEL_T_RT_LOOKUP_VAL
...
@DEL_T_APPLICATION_CONFIGURATIONS_VAL.sql;
@DEL_T_RT_LOOKUP_VAL.sql;
sho ERRORS
